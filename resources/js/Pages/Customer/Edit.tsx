...
import { Customer, CustomerStatusOption, PaymentTermsOption } from '@/types';
import {
    Building2,
    MapPin,
    Phone,
...
export default function CustomerEdit({ customer, statuses, paymentTerms }: CustomerEditProps) {
