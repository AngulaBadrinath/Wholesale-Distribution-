...
import { Customer, CustomerStatusOption, EligibleSalesman, PaymentTermsOption } from '@/types';
import {
    Building2,
    MapPin,
    Phone,
...
export default function CustomerEdit({ customer, statuses, paymentTerms, eligibleSalesmen = [] }: CustomerEditProps) {
    const [sameAsBilling, setSameAsBilling] = useState(
        ...
        (customer.billing_address_line1 === customer.shipping_address_line1 &&
         ...
         customer.billing_postal_code === customer.shipping_postal_code)
    );
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        credit_limit: customer.credit_limit ? String(customer.credit_limit) : '0.00',
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Update wholesale account profile, delivery addresses, and commercial credit limits.
                            </p>
                        </div>
                    </div>
                ...
                {Object.keys(errors).length > 0 && (
                    <div className="flex items-start gap-2 p-4 text-sm text-destructive bg-destructive/10 border border-destructive/20 rounded-lg">
                        ...
                        <div className="space-y-1">
                            <span className="font-semibold">Unable to save customer updates. Please fix errors:</span>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription className="text-xs">
                                Credit limits, payment terms, tax identifier, and lifecycle status.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => setData('payment_terms', e.target.value as any)}
                                        disabled={processing}
